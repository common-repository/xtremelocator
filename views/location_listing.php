<form action="#" method="post" name="adminForm" id="adminForm" class="adminForm">
    <table width="500px" border="0" cellspacing="0" cellpadding="0" class='widefat'>
        <tr>
            <th>
                <img src=<?php print "'" . XL_BASE . "/icons/icon-48-list_locations.png'"; ?> align="absmiddle"/> <?php print __( "Location listing", XL_TEXT_DOMAIN ) ?>
            </th>
                            ...
                            <table class="adminlist">
								...
								foreach ( $afields as $i => $ff ) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="visible[1_4_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfl->visible == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="checkbox" name="title[1_4_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfl->show_title == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="text" name="order[1_4_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="<?php echo $cfl->field_order; ?>"/></td>
                                        <td><input type="checkbox" name="visible[2_4_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfd->visible == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="checkbox" name="title[2_4_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfd->show_title == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="text" name="order[2_4_<?php echo $afields[ $i ]->id; ?>]"
