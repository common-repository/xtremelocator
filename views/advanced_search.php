<form action="#" method="post" name="adminForm" id="adminForm" class="adminForm">
    <table width="500px" border="0" cellspacing="0" cellpadding="0" class='widefat'>
        <tr>
            <th>
                <img src=<?php print "'" . XL_BASE . "/icons/icon-48-advanced_search.png'"; ?> align="absmiddle"/> <?php print __( "Advanced search", XL_TEXT_DOMAIN ) ?>
            </th>
            <th><?php print __( "You can include search to any page/post adding short tag ", XL_TEXT_DOMAIN ) ?><strong>[Xtreme-locator-advanced]</strong>
            </th>
        </tr>
        ...
        <tr>
            <td>
                <table class="adminform">
                    ...
                    <tr>
                        <td><?php print __( "Form code", XL_TEXT_DOMAIN ) ?>:
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <table class="adminlist">
                                ...
                                <tr>
                                    <th>
                                        <a href="admin.php?page=xtreme-locator-advanced-search&amp;sort_by=field_name"><?php print __( "Field", XL_TEXT_DOMAIN ) ?></a>
                                    </th>
                                    <th><?php print __( "Enabled", XL_TEXT_DOMAIN ) ?></th>
                                    <th>
                                        <a href="admin.php?page=xtreme-locator-advanced-search&amp;sort_by=field_id"><?php print __( "Id", XL_TEXT_DOMAIN ) ?></a>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong><a href="admin.php?page=xtreme-locator-advanced-search&amp;sort_by=field_order"><?php print __( "Order", XL_TEXT_DOMAIN ) ?></a></strong>
                                    </td>
                                    <td><strong><?php print __( "Visible", XL_TEXT_DOMAIN ) ?></strong></td>
                                    <td><strong><?php print __( "Show title", XL_TEXT_DOMAIN ) ?></strong></td>
                                    <td>
								...
								foreach ( $afields as $i => $ff ) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="visible[1_3_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfl->visible == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="checkbox" name="title[1_3_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfl->show_title == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="text" name="order[1_3_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="<?php echo $cfl->order; ?>"/></td>
                                        <td><input type="checkbox" name="visible[2_3_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfd->visible == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="checkbox" name="title[2_3_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="1" <?php echo $cfd->show_title == 1 ? 'checked="checked"' : ""; ?>/>
                                        </td>
                                        <td><input type="text" name="order[2_3_<?php echo $afields[ $i ]->id; ?>]"
                                                   value="<?php echo $cfd->order; ?>"/></td>
                                    </tr>
								<?php } ?>
