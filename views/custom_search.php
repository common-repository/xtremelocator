<form action="#" method="post" name="adminForm" id="adminForm" class="adminForm">
    <table width="500px" border="0" cellspacing="0" cellpadding="0" class='widefat'>
        <tr>
            <th>
                <img src=<?php print "'" . XL_BASE . "/icons/icon-48-custom.png'"; ?> align="absmiddle"/> <?php print __( "Custom search", XL_TEXT_DOMAIN ) ?>
            </th>
            <th><?php print __( "You can include search to any page/post adding short tag ", XL_TEXT_DOMAIN ) ?><strong>[Xtreme-locator-custom]</strong>
            </th>
        </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <table class="adminlist">
                                ...
                                <tr>
                                    <th>
                                        <a href="admin.php?page=xtreme-locator-custom-search&amp;sort_by=field_name"><?php print __( "Field", XL_TEXT_DOMAIN ) ?></a>
                                    </th>
                                    <th><?php print __( "Enabled", XL_TEXT_DOMAIN ) ?></th>
                                    <th>
                                        <a href="admin.php?page=xtreme-locator-custom-search&amp;sort_by=field_id"><?php print __( "Id", XL_TEXT_DOMAIN ) ?></a>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong><a href="admin.php?page=xtreme-locator-custom-search&amp;sort_by=field_order"><?php print __( "Order", XL_TEXT_DOMAIN ) ?></a></strong>
                                    </td>
                                    <td><strong><?php print __( "Visible", XL_TEXT_DOMAIN ) ?></strong></td>
                                    <td><strong><?php print __( "Show title", XL_TEXT_DOMAIN ) ?></strong></td>
                                    <td>
